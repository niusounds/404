...
![暗い廊下の平面図。5つの部屋が描かれている中に赤い線のみで枠組みされた「4号室」の空間が壁に挟まれ、出入口がない状態](/assets/images/blueprint-hole.svg)
...
![現場の測位結果を図面上に重ねた比較図。右側は青線で完成計画、左側は赤の実測値。六番目の空間が壁に埋まっていることが可視化される](!(/assets/images/measure-overlap.svg))
...
![壁面を破られた後の写真。内部から覗く狭い空間、壁裏に手すりが取り付けられている](!(/assets/images/wall-interior.svg))

*「調査チームが3号室の内壁を破壊した際、内側から配管ではなく金属製の手すりが出てきた。階層間をつなぐ階段の手すりという判断。」— 同報告書 7ページ*

---

![階段を下りる手すりの断面図とその横に書かれた高さ寸法](!(/assets/images/stair-tread.svg))
...
![最下部に到達した際の写真。狭い部屋の中の一角に設置された簡素な生活スペースが写る](!(/assets/images/hidden-room.svg))

*「部屋面積約2.6平米の密室。調理器具がなく、トイレもないため居住不可能と思われたが、床一面に布や段ボールでできた『生活痕跡』が存在していた。」— 同報告書 13ページ*

---

![生活痕跡の中から回収された手書きメモ群](!(/assets/images/scribbled-note.svg))
...
![インターホン画面のスクリーンショット。表示される部屋番号が「4」で、ボタンを押されていないにもかかわらず履歴に残っている状態](!(/assets/images/intercom-recording.svg))
